...
export const metadata: Metadata = {
  ...
  other: {
    ...
    'rights': 'Images may be subject to copyright. Recipe App does not claim ownership of external images.',
    'robots': 'index, follow',
  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta name="rights" content="Images sourced via Google Custom Search and other APIs are subject to their respective terms of use and copyright" />
      </head>
      <body className="bg-base-200">
        ...
        <footer className="footer p-4 bg-base-300 text-base-content">
          <div className="items-center grid-flow-col">
            <p>&copy; {new Date().getFullYear()} Recipes App. All rights reserved. External images may be subject to copyright.</p>
          </div>
        </footer>
      </body>
    </html>
